...
# Creating schema
(schema, attributes) = build_relationships_schema(dataset=INPUT_DATASET_NAME, key_a=graph_nodes_left_key, key_b=GRAPH_NODES_TO_KEY, set_properties=GRAPH_RELATIONSHIP_SET_PROPERTIES)
